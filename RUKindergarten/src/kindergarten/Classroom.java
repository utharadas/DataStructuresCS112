...
public class Classroom {
    ...
    public void enterClassroom ( String filename ) {
        ...
        for (int a = 0; a < numberOfStudents; a++){
            ...
            Student studentObject = new Student(firstName,lastName,height);
            SNode newStudent = new SNode();
            newStudent.setStudent(studentObject);
    ...
    public void setupSeats(String seatingChart) {
        ...
        for(int i =0;i<rows;i++){
            for(int j=0;j<cols;j++){
                boolean seatExist = StdIn.readBoolean();
                if(seatExist == false){
        ...
        for(int r=0; r<studentsSitting.length; r++){
            for(int c=0; c<studentsSitting[r].length; c++){
                if(studentsInLine != null){
                    if(seatingLocation[r][c] == true && studentsSitting[r][c] == null){
    ...
    for(int i=0; i<studentsSitting.length;i++){
        for(int j=0; j<studentsSitting[i].length; j++){
            ...
            studentsSitting[i][j] = null;
                ...
                musicalChairs = new SNode(seatedStudent, null);
                musicalChairs.setNext(musicalChairs);
                }
                else{
                musicalChairs.setNext(new SNode(seatedStudent,musicalChairs.getNext())); 
    ...
    public void moveStudentFromChairsToLine(int size) {
        int current = 0;
        int studentNumber = StdRandom.uniform(size);
    ...
    public void insertByHeight(Student studentToInsert) {
        ...
        student.setStudent(studentToInsert);
        ...
        if(studentsInLine == null){
            ...
            while(pointer != null){
                // Shortest Student 
                // System.out.println(pointer.getStudent().print() + pointer.getStudent().getHeight() + "StudentToInsert: " + studentToInsert.print() + " " + studentToInsert.getHeight());
                if(height < studentsInLine.getStudent().getHeight()){
                    // System.out.println("1");
                    student.setNext(studentsInLine);
                    studentsInLine = student;
                    break;
                }else if (pointer.getNext() != null){
                    if (pointer.getStudent().getHeight() <= height && pointer.getNext().getStudent().getHeight() > height){
                        // System.out.println("2");
                        student.setNext(pointer.getNext());
                ...
                // Tallest Student
                    ...
                    if (pointer.getStudent().getHeight() <= height){
                        pointer.setNext(student);
